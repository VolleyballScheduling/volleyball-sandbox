...
/**
 * @ORM\Entity(repositoryClass="Volleyball\CourseBundle\Repository\CourseRepository")
...
class Course
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Organization", inversedBy="course")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Council", inversedBy="course")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Region", inversedBy="course")
