...
class AttendeeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('faction',   'entity',   array('property' =>  'name', 'class' => 'Volleyball\PasselBundle\Entity\Faction'));
        $builder->add('passel',  'entity',   array('property' =>  'name', 'class' => 'Volleyball\PasselBundle\Entity\Passel'));
    }
