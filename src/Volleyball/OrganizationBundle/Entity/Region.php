...
class Region
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\PasselBundle\Entity\Passel", mappedBy="region")
     */
    protected $passels;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\FacilityBundle\Entity\Facility", mappedBy="region")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\FacilityBundle\Entity\Faculty", mappedBy="region")
     */
    protected $faculty;
     ...
     * Add facilities
     *
     * @param \Volleyball\FacilityBundle\Entity\Facility $facilities
     * @return Region
     */
    public function addFacilitie(\Volleyball\FacilityBundle\Entity\Facility $facilities)
    {
        $this->facilities[] = $facilities;
     ...
     * @param \Volleyball\FacilityBundle\Entity\Facility $facilities
     */
    public function removeFacilitie(\Volleyball\FacilityBundle\Entity\Facility $facilities)
    {
