...
class Facility
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\UtilityBundle\Entity\Address", inversedBy="facility")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Organization", inversedBy="facility")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Council", inversedBy="facility")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Region", inversedBy="facility")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\FacilityBundle\Entity\Quarters", inversedBy="facility")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\FacilityBundle\Entity\Department", inversedBy="facility")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\EnrollmentBundle\Entity\Season", inversedBy="facility")
     ...
     * @return Facility
     */
    public function setQuarters(Volleyball\FacilityBundle\Entity\Quarters $quarters = null)
    {
