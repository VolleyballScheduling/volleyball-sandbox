...
/**
 * @ORM\Entity(repositoryClass="Volleyball\OrganizationBundle\Repository\CouncilRepository")
...
class Council
{
    ...
    public function setOrganization(Volleyball\OrganizationBundle\Entity\Organization $organization)
    {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\PasselBundle\Entity\Passel", mappedBy="council")
     */
    protected $passels;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\FacilityBundle\Entity\Facility", mappedBy="council")
     */
    ...
    public function removeFacility($facility)
    {
        ...
        /**
     * @ORM\OneToMany(targetEntity="Volleyball\FacilityBundle\Entity\Faculty", mappedBy="council")
     */
    protected $facultys;
