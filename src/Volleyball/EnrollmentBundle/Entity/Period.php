...
/**
 * @ORM\Entity(repositoryClass="Volleyball\EnrollmentBundle\Repository\PeriodRepository")
...
class Period
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\EnrollmentBundle\Entity\Week", inversedBy="period")
