...
use Volleyball\EnrollmentBundle\Entity\Passel as PasselEnrollment;
use Volleyball\PasselBundle\Entity\Type;
 ...
 * @ORM\Entity(repositoryClass="Volleyball\PasselBundle\Repository\PasselRepository")
 */
class Passel
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Council", inversedBy="passel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\OrganizationBundle\Entity\Region", inversedBy="passel")
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\EnrollmentBundle\Entity\PasselEnrollment", mappedBy="passel")
     */
