...
/**
 * @ORM\Entity(repositoryClass="Volleyball\OrganizationBundle\Repository\OrganizationRepository")
...
class Organization
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\PasselBundle\Entity\Type", mappedBy="organization")
     */
    protected $types;
     ...
     * @return self
     */
    public function addType(Volleyball\PasselBundle\Entity\Type $type)
    {
        $this->types->add($type);
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\PasselBundle\Entity\Passel", mappedBy="organization")
     */
    protected $passels;
     ...
     * @return self
     */
    public function addPassel(Volleyball\PasselBundle\Entity\Passel $passel)
    {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\FacilityBundle\Entity\Facility", mappedBy="organization")
     */
     ...
     * @return self
     */
    public function addFacility(Volleyball\FacilityBundle\Entity\Facility $facility)
    {
    ...
    public function removeFacility($facility)
    {
        ...
        /**
     * @ORM\OneToMany(targetEntity="Volleyball\FacilityBundle\Entity\Faculty", mappedBy="organization")
     */
    protected $facultys;
     ...
     * @return self
     */
    public function addFaculty(Volleyball\FacilityBundle\Entity\Faculty $faculty)
    {
