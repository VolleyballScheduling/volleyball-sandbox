...
/**
 * @ORM\Entity(repositoryClass="Volleyball\EnrollmentBundle\Repository\WeekRepository")
 * @ORM\Table(name="week")
 */
class Week
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\EnrollmentBundle\Entity\Season", inversedBy="week")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Volleyball\FacilityBundle\Entity\Facility", inversedBy="week")
