...
class Region
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\Bundle\PasselBundle\Entity\Passel", mappedBy="region")
     */
    protected $passels;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\Bundle\FacilityBundle\Entity\Facility", mappedBy="region")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Volleyball\Bundle\FacilityBundle\Entity\Faculty", mappedBy="region")
     */
    protected $faculty;
     ...
     * Add facilities
     *
     * @param \Volleyball\Bundle\FacilityBundle\Entity\Facility $facilities
     * @return Region
     */
    public function addFacilitie(\Volleyball\Bundle\FacilityBundle\Entity\Facility $facilities)
    {
        $this->facilities[] = $facilities;
     ...
     * @param \Volleyball\Bundle\FacilityBundle\Entity\Facility $facilities
     */
    public function removeFacilitie(\Volleyball\Bundle\FacilityBundle\Entity\Facility $facilities)
    {
